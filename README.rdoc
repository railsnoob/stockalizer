...
* Open one browser at http://localhost/data/new . Click onthe "Create" button to create new quotes. Your pages should update in real time. 

== Supporting Real Time in Production

* Add RedisToGo Nano instance to your heroku stockalizer app
* Create a new heroku instance to run the stockalizer-node server. Code is here: https://github.com/railsnoob/stockalizer-node
* In the stockalizer-node heroku instance make sure to copy the REDISTOGO_URL from your heroku app.
* Reload your webpages and navigate to /data/new on your rails app. You will find a button to create new quotes and all clients will update in real time. 
